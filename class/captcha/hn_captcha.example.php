...
// Please type in all needed values before run the script!
    ...
    // ConfigArray
    $CAPTCHA_INIT = [
            'tempfolder' => $_SERVER['DOCUMENT_ROOT'] . '/changetheworld/web/_captcha_tmp/',      // string: absolute path (with trailing slash!) to a writeable tempfolder which is also accessible via HTTP!
            'TTF_folder' => $_SERVER['DOCUMENT_ROOT'] . '/changetheworld/web/fonts/', //_rsrc/TTF/', // string: absolute path (with trailing slash!) to folder which contains your TrueType-Fontfiles.
                                // mixed (array or string): basename(s) of TrueType-Fontfiles
            'TTF_RANGE' => ['BROADW.TTF', 'CHILLER.TTF', 'ELEPHNT.TTF', 'ARIBLK.TTF', 'BAUHS93.TTF'], //,'MREARL.TTF','RUBBERSTAMP.TTF','ZINJARON.TTF'),
        //	'TTF_RANGE'      => 'COMIC.TTF',

            'chars' => 5,       // integer: number of chars to use for ID
            'minsize' => 12,      // integer: minimal size of chars
            'maxsize' => 14,      // integer: maximal size of chars
            'maxrotation' => 15,      // integer: define the maximal angle for char-rotation, good results are between 0 and 30
            ...
            'secretposition' => 22,      // integer: [1-32]
