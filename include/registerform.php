...
$email_text = new XoopsFormText('', 'email', 25, 60, htmlspecialchars($email, ENT_QUOTES | ENT_HTML5));
...
$reg_form->addElement(new XoopsFormText(_US_NICKNAME, 'uname', $uname_size, $uname_size, htmlspecialchars($uname, ENT_QUOTES | ENT_HTML5)), true);

$reg_form->addElement($email_tray);

$reg_form->addElement(new XoopsFormText(_US_WEBSITE, 'url', 25, 255, htmlspecialchars($url, ENT_QUOTES | ENT_HTML5)));
...
$reg_form->addElement(new XoopsFormPassword(_US_PASSWORD, 'pass', 10, 32, htmlspecialchars($pass, ENT_QUOTES | ENT_HTML5)), true);

$reg_form->addElement(new XoopsFormPassword(_US_VERIFYPASS, 'vpass', 10, 32, htmlspecialchars($vpass, ENT_QUOTES | ENT_HTML5)), true);
...
$reg_form->addElement(new XoopsFormLabel('Validation', $captcha->display_form()));
